...
using ApiModelFile = DiffusionNexus.Service.Classes.CivitaiModels.ModelFile;
using ApiModelImage = DiffusionNexus.Service.Classes.CivitaiModels.ModelImage;
using ApiModelVersion = DiffusionNexus.Service.Classes.CivitaiModels.ModelVersion;
using DbModel = DiffusionNexus.DataAccess.Entities.Model;
using DbModelVersion = DiffusionNexus.DataAccess.Entities.ModelVersion;
...
public class ModelDataImportService
{
    ...
    private DbModelVersion MapToModelVersion(ApiModelVersion data)
    {
        ...
        if (data.Files != null)
        {
            ...
            {
                version.Files.Add(new DiffusionNexus.DataAccess.Entities.ModelFile
                {
        ...
        if (data.Images != null)
        {
            ...
            {
                version.Images.Add(new DiffusionNexus.DataAccess.Entities.ModelImage
                {
                    Url = imageData.Url,
